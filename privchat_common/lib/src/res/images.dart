class ImageRes {
  ...
  static const profileEdit = "$_dir/ic_mine_profile.png";
  static const workingCircle = "$_dir/ic_working_circle.webp";
  static const accountSetup = "$_dir/ic_mine_security.png";
  static const settingSetup = "$_dir/ic_mine_setting.png";
  static const securitySetup = "$_dir/ic_mine_security.png";
  static const notificationSetup = "$_dir/ic_mine_notification.png";
